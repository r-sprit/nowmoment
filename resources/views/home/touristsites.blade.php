                ...
                <div class="text-center m-t-lg">
                    ...
                    <div class="tab-content">
                        <div id="my_map_googlemap" class="tab-pane fade in active">
                            <div id="main_map" style="width: 100%; height: 400px;">
                            </div>
                        </div>
...
@section('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            url = "http://openapi.gg.go.kr/STRETTURSMINFO?key=93c8f67b82c9453e92a50dc5d3280ee3&type=json&pSize=1000";

            $.get( url, function( data ) {
                $( "#results" ).html( data );
                console.log(data);
                var outdata = data.STRETTURSMINFO[1].row;
