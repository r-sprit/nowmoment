        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="text-center m-t-lg">
                    <h1>
                        Local Cultural Heritage in Gyeonggi Province of Korea
                    </h1>
...
@section('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            url = "http://openapi.gg.go.kr/LOCALCULTRELC?key=93c8f67b82c9453e92a50dc5d3280ee3&type=json&pSize=1000";
            $.get( url, function( data ) {
                $( "#results" ).html( data );
                console.log(data);
                var outdata = data.LOCALCULTRELC[1].row;
